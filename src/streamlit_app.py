...
from src.zhipuai_llm import ZhipuAILLM
...
def generate_response(input_text, zhipuai_api_key):
    llm = ZhipuAILLM(model="glm-4", temperature=0.1, api_key=zhipuai_api_key)  # model="glm-4-0520",
...
def get_chat_qa_chain(question:str,openai_api_key:str):
    ...
    llm = ZhipuAILLM(model_name = "gpt-3.5-turbo", temperature = 0,openai_api_key = openai_api_key)
